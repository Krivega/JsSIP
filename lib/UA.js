...
module.exports = class UA extends EventEmitter
{
  ...
  _loadConfig(configuration)
  {
    ...
    try
    {
      ...
      this._transport.onreconnectionFailed = onTransportReconnectionFailed.bind(this);
...
// Transport reconnection failed event.
function onTransportReconnectionFailed(data)
{
